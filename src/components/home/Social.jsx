  ...
  return (
    <div className="flex flex-col w-fit text-xl text-gray-500 ">
      <a
        ...
        <i className="bx bxl-github  hover:text-title-color-dark"></i>
      </a>
      <a
        href="https://www.linkedin.com/in/hesham-elsayed-5034ba179/"
        target="_blank"
        rel="noopener noreferrer">
        <i className="bx bxl-linkedin-square hover:text-title-color-dark"></i>
      </a>
      <a
        href="https://www.instagram.com/hesham_elsayeed/"
        target="_blank"
        rel="noopener noreferrer">
        <i className="bx bxl-instagram-alt hover:text-title-color-dark"></i>
      </a>
    </div>
  );
}
